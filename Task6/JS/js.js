...
function validateForm() {
 ...
 {
   document.getElementById("errorpass").innerHTML="Your Password must contains 6 characters";
   // return false;
  }
  else 
  {
  ...
  if (comment.length<15) {
    document.getElementById("errorcomment").innerHTML="Comment contains 8 characters";
    // return false;
   }
   else 
   {
   ...
   {
     document.getElementById("errorgen").innerHTML="Gender must be requried";
    // return false;
   }
   else{
